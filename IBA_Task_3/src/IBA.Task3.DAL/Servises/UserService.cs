...
{
    public class UserService : AbstractService<Context.AppContext, User>, IUserService
    {
        public UserService(Context.AppContext context) : base(context)
        {
        }
    ...
    {
        Task<IEnumerable<NamedEntity>> AllNamedAsync(System.Func<User, bool> func, CancellationToken token = default);
    }
}